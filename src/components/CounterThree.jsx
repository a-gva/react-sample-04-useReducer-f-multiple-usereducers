    ...
    return (
        <div>
            ...
            <div>
                ...
                <button onClick={() => dispatchTwo(ACTIONS.DECREMENT)}>Decrement</button>
                <button onClick={() => dispatchTwo(ACTIONS.INCREMENT)}>Increment</button>
                <button onClick={() => dispatchTwo(ACTIONS.RESET)}>Reset</button>
            </div>
        </div>
    )
}
